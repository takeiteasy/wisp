...
This is a fork of wisp, the original project is abandoned/maintainance mode. Note, the old wisp on npm has old dependencies that have been updated. I wouldn't recommend installing the original, given the security around npm. See [language-essentials.md](./language-essentials.md) for details.
